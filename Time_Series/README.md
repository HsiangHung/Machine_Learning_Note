...
is only expressed in terms of its past values and the current and past values of error terms, and <a href="https://www.codecogs.com/eqnedit.php?latex=Y^{\prime}_t" target="_blank"><img src="https://latex.codecogs.com/gif.latex?Y^{\prime}_t" title="Y^{\prime}_t" /></a>
