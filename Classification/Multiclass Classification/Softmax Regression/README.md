...
$$h_{\theta}(x_i) = \begin{bmatrix} P(y_i=1|\theta, \symbf{x}_i) \\ P(y_i=2|\theta, \symbf{x}_i) \\ \vdots \\ P(y_i=K|\theta, \symbf{x}_i) \end{bmatrix} = $$
...
$$\Theta = \begin{pmatrix} \begin{pmatrix} a \vert \\ \theta^{(1)} \\ a \vert \end{pmatrix} & \begin{pmatrix} | \\ \theta^{(2)} \\ | \end{pmatrix} & \cdots & \begin{pmatrix} | \\ \theta^{(K)} \\ | \end{pmatrix} \end{pmatrix}$$
