...
1. Say, we got our customers' complaint, the checkout services sometimes have high latency. 
2. Fetch the response time data in the past three days. Big spikes indicate high response time.
3. To further investigate, narrow down the anomaly spikes.
