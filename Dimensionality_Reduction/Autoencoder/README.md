...
The first term comes the reconstruction `cost C(x,x̂)`, which is the same as the cost function in [supervised neueral networks](http://ufldl.stanford.edu/tutorial/supervised/MultiLayerNeuralNetworks/). If followed Andrew Ng's notation, we have
