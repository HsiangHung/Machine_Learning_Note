...
<a href="https://www.codecogs.com/eqnedit.php?latex=\&space;\&space;\&space;\&space;=&space;\frac{\Gamma(\alpha&plus;\beta)}{\Gamma(\alpha)\Gamma(\beta)}&space;\theta^{\alpha^{'}-1}(1-\theta)^{\beta^{'}-1},&space;\textrm{&space;where&space;}&space;\alpha^{'}=\alpha&plus;N_H,&space;\&space;\beta^{'}=\beta&plus;N_T" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\&space;\&space;\&space;\&space;=&space;\frac{\Gamma(\alpha&plus;\beta)}{\Gamma(\alpha)\Gamma(\beta)}&space;\theta^{\alpha^{'}-1}(1-\theta)^{\beta^{'}-1},&space;\textrm{&space;where&space;}&space;\alpha^{'}=\alpha&plus;N_H,&space;\&space;\beta^{'}=\beta&plus;N_T" title="\ \ \ \ = \frac{\Gamma(\alpha+\beta)}{\Gamma(\alpha)\Gamma(\beta)} \theta^{\alpha^{'}-1}(1-\theta)^{\beta^{'}-1}, \textrm{ where } \alpha^{'}=\alpha+N_H, \ \beta^{'}=\beta+N_T" /></a>
